...
void I2C_Setup(void)
{
  ...
  GPIO_PinModeSet(gpioPortE, 12, gpioModeWiredAnd, 1);
  GPIO_PinModeSet(gpioPortE, 13, gpioModeWiredAnd, 1);

  /* Enable pins at location 3 (which is used on the DVK) */
  I2C0->ROUTE = I2C_ROUTE_SDAPEN |
                I2C_ROUTE_SCLPEN |
                (6 << _I2C_ROUTE_LOCATION_SHIFT);

  I2C_Init(I2C0, &i2cInit);

  /* Clear and enable interrupt from I2C module */
//  I2C_IntClear(I2C0, I2C_IEN_TXC);
