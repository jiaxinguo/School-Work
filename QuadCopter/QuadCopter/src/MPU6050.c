...
{
	uint8_t Data = 0x00;
	I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_WHO_AM_I, &Data, 1);
...
void Calibrate_Gyros()
{
	...
	for(x = 0; x<5000; x++)
	{
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_GYRO_XOUT_H, &GYRO_XOUT_H, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_GYRO_XOUT_L, &GYRO_XOUT_L, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_GYRO_YOUT_H, &GYRO_YOUT_H, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_GYRO_YOUT_L, &GYRO_YOUT_L, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_GYRO_ZOUT_H, &GYRO_ZOUT_H, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_GYRO_ZOUT_L, &GYRO_ZOUT_L, 1);
...
void Calibrate_Acc()
{
	...
	for(x = 0; x<5000; x++)
	{
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_ACCEL_XOUT_H, &ACCEL_XOUT_H, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_ACCEL_XOUT_L, &ACCEL_XOUT_L, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_ACCEL_YOUT_H, &ACCEL_YOUT_H, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_ACCEL_YOUT_L, &ACCEL_YOUT_L, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_ACCEL_ZOUT_H, &ACCEL_ZOUT_H, 1);
		I2C_RegisterGet(I2C0, MPU6050_ADDRESS, MPU6050_RA_ACCEL_ZOUT_L, &ACCEL_ZOUT_L, 1);
