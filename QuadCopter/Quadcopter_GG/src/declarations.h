...
float GYRO_YRATE = 0;
float GYRO_ZRATE = 0;
int16_t GYRO_XRATERAW = 0;
int16_t GYRO_YRATERAW = 0;
int16_t GYRO_ZRATERAW = 0;
...
int64_t GYRO_XOUT_OFFSET_1000SUM = 0;
int64_t GYRO_YOUT_OFFSET_1000SUM = 0;
int64_t GYRO_ZOUT_OFFSET_1000SUM = 0;

int64_t ACC_XOUT_OFFSET_1000SUM = 0;
int64_t ACC_YOUT_OFFSET_1000SUM = 0;
int64_t ACC_ZOUT_OFFSET_1000SUM = 0;
...
int16_t ACC_XOUT_OFFSET = 0;
int16_t ACC_YOUT_OFFSET = 0;
int16_t ACC_ZOUT_OFFSET = 0;
